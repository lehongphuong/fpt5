			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<html:form action="/update-code.do">
								<div class="form-group">
									<label>ID</label>
									<html:text styleClass="form-control" property="codeId" readonly="true"  ></html:text>
									
									<label>Submit</label>
									<html:select styleClass="form-control" property="submitId">
									
									<logic:iterate id="submit" name="codeForm" property="submitList" >
									<bean:define id="idUser" name="submit" property="userId" ></bean:define>
									
									<html:option value="${idUser }">
										<logic:iterate id="user" name="codeForm" property="userList">
											<logic:equal name="user" property="userId" value="${idUser }">
									...
									<label>Code</label>
									<html:textarea property="code" styleClass="ckeditor" cols="70" rows="5"></html:textarea>
								</div>
