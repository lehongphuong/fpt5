			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<html:form action="/add-code.do" method="post">
								<div class="form-group">
									<label>SubmitId</label>
									<html:select property="submitId" styleClass="form-control">
										<html:optionsCollection name="codeForm" property="submitList" label="title" value="submitId"/>
									</html:select>
									<label>Code</label>
									<html:textarea property="code" styleClass="ckeditor" cols="70" rows="3"></html:textarea>
								</div>
