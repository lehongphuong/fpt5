...
<body>
					...
					<div class="panel-body">
						<div class="col-lg-12">
							<html:form action="/update-testcase.do">
									...
									<label>Id</label>
									<html:text styleClass="form-control" property="testId" readonly="true"  ></html:text>
									
									<label>Title</label>
                                    <html:select styleClass="form-control" property="subId">
                                    <html:optionsCollection name="testCaseForm" property="subList" label="title" value="subId"/>
                                    </html:select>
									
									<label>input</label>
									<html:text styleClass="form-control" property="input"  ></html:text>
									
									<label>output</label>
									<html:text styleClass="form-control" property="output" ></html:text>
									<label>timeask</label>
									<html:text styleClass="form-control" property="timeAsk" ></html:text>
								</div>
	...
	<script src="adminjs/chart-data.js"></script>
