...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu" style="padding-top:30px;font-size:20px;font-family:myFirstFont">
			...
			<li class="active"><a href="/FPT/list-code.do"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>Code</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="admin/code/addcode.jsp"><input class="btn" type="submit" name="them" value="Add Code" /></a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
							...
							<tbody>
									<logic:iterate id="code" name="codeForm" property="codeList">
							<tr>
								
								<td><jsp:getProperty name="code" property="codeId"/> </td>
								
								<td><bean:write name="code" property="code"/> </td>
								
								<bean:define id="idcode" name="code" property="codeId"></bean:define>
								<td>
								<html:link action="/prepare-update-code.do?codeId=${idcode}"  styleClass = "btn btn-primary">Edit</html:link>
								</td>
								
								<td>
									<div>
									<button type="button" class="btn btn-info btn-danger" id="myBtn${idcode}">Delete</button>
									<div class="modal fade" id="myModal${idcode }" role="dialog">
									    <div class="modal-dialog">
									      ...
									      <div class="modal-content">
									        ...
									        <div class="modal-footer">
									          <html:link action="/delete-code.do?codeId=${idcode}" styleClass="btn btn-danger" >OK</html:link>
									  ...
									  <bean:define id="name1" value="#myModal${idcode}"></bean:define>
									  <script>
									  
										  $(document).ready(function(){
											    $("#myBtn${idcode}").click(function(){
											        $("${name1}").modal();
											    });
											});
