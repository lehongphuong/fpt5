...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu" style="padding-top:30px;font-size:20px;font-family:myFirstFont">
			...
			<li class="active"><a href="/FPT/list-problem.do"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg>Problem</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="prepare-add-problem.do"><input class="btn" type="submit" name="them" value="Add Problem" /></a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="id" data-sortable="true">Problem id</th>
						        <th data-field="subid" data-sortable="true">SubID</th>
						        <th data-field="description"  data-sortable="true">description</th>
						        <th data-field="constrain" data-sortable="true">constrain</th>
								<th data-field="inputRequire" data-sortable="true">inputRequire</th>
								<th data-field="outputRequire" data-sortable="true">outputRequire</th>
								<th data-field="inputTestCase" data-sortable="true">inputTestcase</th>
								<th data-field="outputTestCase" data-sortable="true">outputTestcase</th>
								<th data-field="explain" data-sortable="true">explain</th>
								<th data-field="inputUser" data-sortable="true">inputUser</th>
							...
							<logic:iterate id="problem" name="problemForm" property="problemList">
							<tr>
								
								<td><jsp:getProperty name="problem" property="proId"/> </td>
								<td><jsp:getProperty name="problem" property="subId"/> </td>
								<td><bean:write name="problem" property="description"/> </td>
								<td><bean:write name="problem" property="constrain"/> </td>
								<td><bean:write name="problem" property="inputRequire"/> </td>
								<td><bean:write name="problem" property="outputRequire"/> </td>
								
								<td><bean:write name="problem" property="inputTestCase"/> </td>
								<td><bean:write name="problem" property="outputTestCase"/> </td>
								<td><bean:write name="problem" property="explain"/> </td>
								<td><bean:write name="problem" property="inputUser"/> </td>
								
								<bean:define id="IdPro" name="problem" property="proId"></bean:define>
								<td>
								<html:link action="/prepare-update-problem.do?proId=${IdPro}"  styleClass = "btn btn-primary">Edit</html:link>
								</td>
								...
								<td>
									...
									<button type="button" class="btn btn-info btn-danger" id="myBtn${IdPro}">Delete</button>
									<div class="modal fade" id="myModal${IdPro}" role="dialog">
									    <div class="modal-dialog">
									      ...
									      <div class="modal-content">
									        ...
									        <div class="modal-footer">
									          <html:link action="/delete-problem.do?proId=${IdPro}" styleClass="btn btn-danger"  >OK</html:link>
									  ...
									  <bean:define id="name1" value="#myModal${IdPro}"></bean:define>
									  <script>
									  
										  $(document).ready(function(){
											    $("#myBtn${IdPro}").click(function(){
											        $("${name1}").modal();
											    });
											});
