...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu" style="padding-top:30px;font-size:20px;font-family:myFirstFont">
			...
			<li class="active"><a href="/FPT/list-testcase.do"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>Testcase</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="prepare-add-testcase.do"><input type="submit" class="btn" name="them" value="Add Testcase" /></a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="output" data-sortable="true">output</th>
								<th data-field="timeAsk" data-sortable="true">timeAsk</th>
							...
							<tbody>
								<logic:iterate id="testcase1" name="testCaseForm" property="testCaseList">
							<tr>
								
								<td><jsp:getProperty name="testcase1" property="subId"/> </td>
								<td><bean:write name="testcase1" property="input"/> </td>
								<td><bean:write name="testcase1" property="output"/> </td>
								<td><jsp:getProperty name="testcase1" property="timeAsk"/> </td>
								
								
								<bean:define id="idTest" name="testcase1" property="testId"></bean:define>
								<td>
								<html:link action="/prepare-update-testcase.do?testId=${idTest}"  styleClass = "btn btn-primary">Edit</html:link>
								</td>
								
								<td>
									<div>
									
									<button type="button" class="btn btn-danger" id="myBtn${idTest}">Delete</button>
									<div class="modal fade" id="myModal${idTest}" role="dialog">
									    <div class="modal-dialog">
									      ...
									      <div class="modal-content">
									        ...
									        <div class="modal-footer">
									          <html:link action="/delete-testcase.do?testId=${idTest}" styleClass="btn btn-default" >OK</html:link>
									  ...
									  <bean:define id="name1" value="#myModal${idTest}"></bean:define>
									  <script>
									  
										  $(document).ready(function(){
											    $("#myBtn${idTest}").click(function(){
											        $("${name1}").modal();
											    });
											});
