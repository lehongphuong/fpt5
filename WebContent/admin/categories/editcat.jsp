...
<!--Icons-->
<script src="adminjs/lumino.glyphs.js"></script>

 <!-- library -->
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.0/css/font-awesome.min.css">
      <!-- CSS -->
      <!-- <link href="lib/css/compiled.min.css" rel="stylesheet"> -->
      <!-- <script src="adminhttps://ajax.googleapis.com/ajax/libs/angularjs/1.4.8/angular.min.js"></script> -->
      <!-- Bootstrap core CSS -->
						...
						<div class="col-lg-12">
							<html:form action="/update-categories.do">
								...
								<div class="form-group">
									<label>Cate Id</label>
									<html:text styleClass="form-control" property="cateId" readonly="true"  ></html:text>
									<label>Name menu</label>
									<html:select styleClass="form-control" property="menuId">
										<html:optionsCollection name="categoriesForm" property="menuList" label="name" value="menuId"/>
									</html:select>
									<label>Name</label>
