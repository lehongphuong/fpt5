						...
						<div class="col-lg-12">
							<html:form action="/update-editorial.do">
								<div class="form-group">
									<div class="form-group">
										<label>EditId</label>
										<html:text styleClass="form-control" property="editId" readonly="true"  ></html:text>
									</div>
									<div class="form-group">
										<label>Name subject</label>
										<html:select styleClass="form-control" property="subId">
											<html:optionsCollection name="editorialForm" property="subjectList" label="title" value="subId"/>
										</html:select>
									</div>
									<div class="form-group">
										<label>Explain</label>
