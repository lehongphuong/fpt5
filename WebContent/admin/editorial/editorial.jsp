...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu" style="padding-top:30px;font-size:20px;font-family:myFirstFont">
			...
			<li class="active"><a href="/FPT/list-editorial.do"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg>Editorial</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="prepare-add-editorial.do"><input class="btn" type="submit" name="them" value="Add Editorial" /></a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						      <th data-field="editid"  data-sortable="true">EditID</th>
							...
							<tbody>
									<logic:iterate id="editorial" name="editorialForm" property="editorialList">
							<tr>
								
								<td><jsp:getProperty name="editorial" property="editId"/> </td>
								<td><jsp:getProperty name="editorial" property="subId"/> </td>
								<td><bean:write name="editorial" property="explain"/> </td>
								<td><bean:write name="editorial" property="code"/> </td>
								
								<bean:define id="idEdit" name="editorial" property="editId"></bean:define>
								<td>
								<html:link action="/prepare-update-editorial.do?editId=${idEdit}"  styleClass = "btn btn-primary">Edit</html:link>
								</td>
								...
								<td>
									...
									<button type="button" class="btn btn-info btn-danger" id="myBtn${idEdit}">Delete</button>
									<div class="modal fade" id="myModal${idEdit}" role="dialog">
									    <div class="modal-dialog">
									      ...
									      <div class="modal-content">
									        ...
									        <div class="modal-footer">
									          <html:link action="/delete-editorial.do?editId=${idEdit}" styleClass="btn btn-danger" >OK</html:link>
									  ...
									  <bean:define id="name1" value="#myModal${idEdit}"></bean:define>
									  <script>
									  
										  $(document).ready(function(){
											    $("#myBtn${idEdit}").click(function(){
											        $("${name1}").modal();
											    });
											});
