...
<body>
	...
	<div id="sidebar-collapse" class="c ol-sm-3 col-lg-2 sidebar">
						...
						<div class="col-lg-12">
							<html:form action="/add-problem.do" method="post">
								...
								<div class="form-group">
									...
									<html:textarea styleClass="ckeditor" cols="70" rows="3" property="outputRequire"></html:textarea>
								</div>
								<div class="form-group">
									<label>inputTestcase</label>
									<html:textarea styleClass="ckeditor" cols="70" rows="3" property="inputTestCase"></html:textarea>
								</div>
								<div class="form-group">
									<label>outputTestCase</label>
									<html:textarea styleClass="ckeditor" cols="70" rows="3" property="outputTestCase"></html:textarea>
								</div>						
								<div class="form-group">
									<label>explain</label>
									...
									<html:textarea styleClass="ckeditor" cols="70" rows="3" property="inputUser"></html:textarea>
								</div>
