...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu" style="padding-top:30px;font-size:20px;font-family:myFirstFont">
			...
			<li class="active"><a href="/FPT/list-status.do"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>Status</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
							...
							<tbody>
							<logic:iterate id="status" name="statusForm" property="statusList">
								<tr>
									<td><jsp:getProperty name="status" property="statusId"/> </td>
									<td><jsp:getProperty name="status" property="userId"/> </td>
									<td><jsp:getProperty name="status" property="subId"/> </td>
									<td><jsp:getProperty name="status" property="status"/> </td>
									
								<bean:define id="idstatus" name="status" property="statusId"></bean:define>
								
								<td>
									<div>
									<button type="button" class="btn btn-info btn-danger" id="myBtn${idstatus}">Delete</button>
									<div class="modal fade" id="myModal${idstatus }" role="dialog">
									  ...
									  <bean:define id="name1" value="#myModal${idstatus}"></bean:define>
									  <script>
									  
										  $(document).ready(function(){
											    $("#myBtn${idstatus}").click(function(){
											        $("${name1}").modal();
											    });
											});
