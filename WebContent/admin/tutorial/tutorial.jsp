...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu" style="padding-top:30px;font-size:20px;font-family:myFirstFont">
			...
			<li class="active"><a href="/FPT/list-tutorial.do"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>Tutorial</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="prepare-add-tutorial.do"><input type="submit" class="btn" name="them" value="Add Tutorial" /></a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th data-field="cateId" data-sortable="true">cateID</th>
							...
							<tbody>
								<logic:iterate id="tutorial" name="tutorialForm" property="tutorialList">
									<tr>
										<td><jsp:getProperty name="tutorial" property="tuId"/> </td>
										<td><bean:write name="tutorial" property="title"/> </td>
										<td><jsp:getProperty name="tutorial" property="positive"/> </td>
										<td><jsp:getProperty name="tutorial" property="active"/> </td>
										<td><jsp:getProperty name="tutorial" property="cateId"/> </td>
										
								<bean:define id="idTu" name="tutorial" property="tuId"></bean:define>
								<td>
								<html:link action="/prepare-update-tutorial.do?tuId=${idTu}"  styleClass = "btn btn-primary">Edit</html:link>
								</td>
								
								<td>
									<div>
									<button type="button" class="btn btn-info btn-danger" id="myBtn${idTu}">Delete</button>
									<div class="modal fade" id="myModal${idTu}" role="dialog">
									    <div class="modal-dialog">
									      ...
									      <div class="modal-content">
									        ...
									        <div class="modal-footer">
									          <html:link action="/delete-tutorial.do?tuId=${idTu}" styleClass="btn btn-danger" >OK</html:link>
									  ...
									  <bean:define id="name1" value="#myModal${idTu}"></bean:define>
									  <script>
									  
										  $(document).ready(function(){
											    $("#myBtn${idTu}").click(function(){
											        $("${name1}").modal();
											    });
											});
